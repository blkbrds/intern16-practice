...
final class BaiTap2ViewController: UIViewController {
    private var names: Array<String> = ["Name1","Name2","Name3", "Name4","Name5","Name6","Name7", "Name8","Name9"]
        private var images: Array<String> = ["avartar","avartar","avartar","avartar","avartar","avartar","avartar","avartar","avartar"]
