...
final class Bai03ViewController: UIViewController {
    ...
    let button1 = BadgeNumberButton()
    let button2 = BadgeNumberButton()
    let button3 = BadgeNumberButton()
    ...
    private func setupView(){
        ...
        button1.text = "123+"
        button1.numberBadgePosition = .topRight
        ...
        button2.text = "90"
        button2.numberBadgePosition = .topCenter
        ...
        button3.text = "10"
        button3.numberBadgePosition = .topLeft
