...
final class BaiTap2ViewController: UIViewController {
    ...
    private func configCircleView() {
        ...
        let circle = CircleGraphic(frame: CGRect(x: (screenSize.width - widthCircle) / 2, y: (screenSize.height - widthCircle) / 2, width: widthCircle, height: widthCircle), percent: 60)
